 ...
 */
public class JIncluirProduto extends javax.swing.JFrame {

    /**
     * Creates new form JAlterarExcluirProduto
     */
    public JIncluirProduto() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JIncluirProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JIncluirProduto().setVisible(true);
            }
        });
    }
