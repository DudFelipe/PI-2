...
public class VendaDAO {
  ...
  public static void atualizarProduto(Venda v) throws SQLException, Exception {
        //Monta a string de atualização do cliente no BD, utilizando
        //prepared statement
        String sql = "UPDATE venda SET numeroDoPedido=?, dataVenda=?, idCliente=?, valoTotal=?"
        ...
        try {
            ...
            preparedStatement.setInt(3, v.getIdCliente());
            preparedStatement.setFloat(4, v.getValorTotal());
            preparedStatement.setInt(5, v.getNumeroDoPedido());
